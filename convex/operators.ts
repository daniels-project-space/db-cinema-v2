...
const SEED = [
  ...
  { role: "music-composer", roleLabel: "Music Composer", firstName: "Theo", years: 11, age: 34, tagline: "Original score & sound design for film and ads — bespoke to your cut.", bio: "Composer writing original score and sound design for film and advertising, bespoke to the cut.", tags: ["Original score", "Sound design", "Mixing"], headshot: hs("Theo"), skills: ["Original score", "Sound design", "Mix"], rateHourly: undefined as number | undefined, rateHalfDay: 220, rateDay: 400, neon: "pink", order: 5, active: true },
